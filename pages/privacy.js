...
export default function PrivacyPolicyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Eviratec</title>
        ...
        <meta property="og:url" content="https://www.eviratec.com.au/privacy" />
      ...
      <main className={styles.main}>
        ...
        <section className={styles.legal}>
          ...
          <p>If you have any questions about this Privacy Policy, please contact us via email: <Link href="mailto:legal@eviratec.com.au">legal@eviratec.com.au</Link>.</p>
        </section>
      </main>
